...
export function SessionSidebar({ collapsed, onToggleCollapsed, onSessionSelected }: SessionSidebarProps) {
  ...
  return (
    <aside
      className={`relative hidden border-r border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 backdrop-blur transition-all duration-300 ease-in-out md:flex md:flex-col ${
